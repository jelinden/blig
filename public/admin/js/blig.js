...
xhr.onload = function() {
    ...
    if (this.responseText.includes("![]()")) {
        ...
        imageUpload.on("success", function(file, responseText) {
            document.getElementById("blogText").value = document
                .getElementById("blogText")
                .value.replace("![]()", "![](" + JSON.parse(responseText).fileName + ")");
            sendPost();
        });
    }
...
var sendPost = debounce(
    function(e) {
        send(blogId, document.getElementById("blogTitle").value, document.getElementById("blogText").value);
    },
    1200,
    false
);
...
auto_grow(document.getElementById("blogText"));
